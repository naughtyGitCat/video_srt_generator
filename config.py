...
class Config:
    ...
    whisper_model_device = 'cuda'  # cuda,cpu,None(without quotes). use None to let whisper auto choose cuda or cpu

    translate = True
    translate_to = "zh"
    translate_api = ["bing", "VolcEngine", "Sogou", "Baidu", "Iflytek", "Yandex"]  # https://github.com/UlionTse/translators
